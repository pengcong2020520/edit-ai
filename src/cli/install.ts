...
function formatConfigSummary(config: InstallConfig): string {
  ...
  lines.push(`  ${SYMBOLS.bullet} Chief        ${SYMBOLS.arrow} ${color.cyan(chiefModel)}`)
  lines.push(`  ${SYMBOLS.bullet} Researcher   ${SYMBOLS.arrow} ${color.cyan(researcherModel)}`)
  lines.push(`  ${SYMBOLS.bullet} Archivist    ${SYMBOLS.arrow} ${color.cyan(archivistModel)}`)
  lines.push(`  ${SYMBOLS.bullet} Writer       ${SYMBOLS.arrow} ${color.cyan(writerModel)}`)
